...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="<?= base_url() ?>/AdminLTE-3.0.5/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?= base_url('/petugas/login/login') ?>" method="post">
      ...
      <div class="social-auth-links text-center mb-3">
        ...
        <a href="<?= base_url(); ?>" class="btn btn-block btn-info">
          <i class="fab fa-users"></i> Masyarakat
        </a>
      </div>
      <!-- /.social-auth-links -->
