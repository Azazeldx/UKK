                      ...
                      <?php foreach ($dataMasyarakat as $index => $masyarakat) : ?>
                        <tr>
                          ...
                          <td class="d-flex justify-content-center">
                            <button type="button" class="btn btn-success m-1 btn-edit" data-toggle="modal" data-target="#modal-ubah" data-whatever="@getbootstrap" data-id_masyarakat="<?= $masyarakat['id_masyarakat']; ?>" data-id_pengguna="<?= $masyarakat['id_pengguna']; ?>" data-nik="<?= $masyarakat['nik']; ?>" data-nama="<?= $masyarakat['nama']; ?>" data-username="<?= $masyarakat['username']; ?>" data-password="<?= $masyarakat['password']; ?>" data-telp="<?= $masyarakat['telp']; ?>">
                              <i class="fas fa-edit"></i>
                              Ubah
                            </button>
                            <button type="button" class="btn btn-danger m-1 btn-delete" data-id="<?= $masyarakat['id_masyarakat']; ?>" data-id_pengguna="<?= $masyarakat['id_pengguna']; ?>">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?= base_url('Admin/masyarakat/update'); ?>" method="POST">
                <input type="hidden" name="id_masyarakat" class="id_masyarakat">
          ...
          <div class="modal-content">
            <form action="<?= base_url('Admin/Masyarakat/hapus/'); ?>" method="post">
              ...
              <div class="modal-body">
                ...
                <input type="hidden" name="id_masyarakat" class="id_masyarakat" id="id_masyarakat">
