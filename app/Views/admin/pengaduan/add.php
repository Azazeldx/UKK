...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" action="<?= base_url('admin/pengaduan/proses_tambah_tanggapan'); ?>" method="POST">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= base_url('Admin/Pengaduan/proses_edit_tanggapan'); ?>" method="POST">
        ...
        <div class="modal fade" style="display: none;" id="modal-hapus">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="<?= base_url('Admin/Pengaduan/proses_hapus_tanggapan'); ?>" method="post">
